...
class AccessControlSeeder extends Seeder
{
    ...
    private const ROLE_PERMISSIONS = [
        ...
        'manager' => ['business_units.view', 'users.view', 'products.view', 'orders.view', 'payments.view', 'inventory.view', 'cms.view', 'reports.view', 'settings.view'],
        'sales' => ['business_units.view', 'products.view', 'orders.view', 'orders.update_status', 'leads.view', 'leads.manage'],
