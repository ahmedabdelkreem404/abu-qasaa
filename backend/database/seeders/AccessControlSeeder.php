...
class AccessControlSeeder extends Seeder
{
    ...
    private const ROLE_PERMISSIONS = [
        ...
        'manager' => ['business_units.view', 'users.view', 'products.view', 'customers.view', 'orders.view', 'payments.view', 'inventory.view', 'branches.view', 'warehouses.view', 'cms.view', 'reports.view', 'settings.view'],
