...
class AccessControlSeeder extends Seeder
{
    ...
    private const PERMISSIONS = [
        ...
        'payments.view', 'payments.review_manual', 'payments.refund',
    ...
    private const ROLE_PERMISSIONS = [
        'business_unit_admin' => [
            ...
            'customers.view', 'customers.create', 'customers.update',
            'orders.view', 'orders.update_status', 'orders.manage',
            'payments.view', 'payments.review_manual',
            'inventory.view', 'inventory.manage',
            'cms.view', 'cms.manage',
            'rfq.view', 'rfq.manage',
            'real_estate.view', 'real_estate.manage',
        ...
        'manager' => ['business_units.view', 'users.view', 'products.view', 'customers.view', 'orders.view', 'payments.view', 'inventory.view', 'cms.view', 'reports.view', 'settings.view'],
        'sales' => ['business_units.view', 'products.view', 'customers.view', 'customers.create', 'orders.view', 'orders.update_status', 'leads.view', 'leads.manage'],
        'inventory_manager' => ['business_units.view', 'products.view', 'inventory.view', 'inventory.manage'],
