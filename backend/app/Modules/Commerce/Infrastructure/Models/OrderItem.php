...
{
    protected $fillable = ['order_id', 'product_id', 'product_variant_id', 'sku', 'product_name_ar', 'product_name_en', 'variant_name_ar', 'variant_name_en', 'quantity', 'unit_price', 'subtotal', 'metadata_json'];
