...
import { JsonUpsertForm } from "@/catalog/json-upsert-form";
...
export default function ProductVariantsPage() {
  ...
  return <section className="space-y-6"><h1 className="text-2xl font-semibold">Product Variants</h1><JsonUpsertForm product={product} kind="variants" /></section>;
}
