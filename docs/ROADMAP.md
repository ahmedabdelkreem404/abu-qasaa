...
Implemented now: Sanctum token login/logout/me endpoints, user status, roles, permissions, scoped business unit assignments, protected admin APIs, permission-aware dashboard navigation, login page, and auth tests.
